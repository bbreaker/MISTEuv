  ...
  allMISTEdat <- function(regDat, estDat) {
    ...
    if(input$eventEst == FALSE) {
      ...
      if(input$givePeakQ == TRUE) {
        ...
        estDat$site_no.y.x <- if_else(is.na(estDat$site_no.y.x), estDat$site_no.y.y, estDat$site_no.y.x)
        
        estDat$event.x <- if_else(is.na(estDat$event.x), estDat$event.y, estDat$event.x)
