    ...
    if(input$eventEst == FALSE) {
      ...
      if (input$use2 == FALSE) {
        ...
        if (input$Method == 1) {
          ...
          datPred$Estimated <- signif(datPred$Estimated*duanSm, 3)
      ...
      datPredRise$Estimated <- signif(datPredRise$Estimated*duanSmRise, 3)
      ...
      datPredFall$Estimated <- signif(datPredFall$Estimated*duanSmFall, 3)
