    ...
    if (input$use2 == FALSE) {
      ...
      if (input$log10 == FALSE) {
        ...
        p <- ggplot() +
          ...
          geom_line(data = datP[!is.na(datP$fitUpper),], aes(x = dateTime, y = fitUpper), color = "grey", linetype = "dashed") +
          geom_line(data = datP[!is.na(datP$fitLower),], aes(x = dateTime, y = fitLower), color = "grey", linetype = "dashed") +
